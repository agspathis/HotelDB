...
public class CheckOutWindow extends javax.swing.JFrame {
    ...
    private void checkOut(){
    	...
    	if(checkIfPayed()){
    		...
    		DatabaseUpdate checkOutUpdate = new DatabaseUpdate(textArea, CHECKOUTQUERY);
    		if(checkOutUpdate.getConnectionState()==true&&
    				checkOutUpdate.execute()){
        		textArea.append(CHECKOUTQUERY+"\n");
        	}else{
    ...
    private boolean checkIfPayed(){
    	...
    	DatabaseGetSelect checkIfPayed = new DatabaseGetSelect(textArea, CHECKIFPAYEDQUERY);
    	...
    	if(checkResult!=null){
    		try {
    			...
    			if(checkResult.getBoolean("payed")==false){
    				JOptionPane.showMessageDialog(null, "Customer hasn't payed", 
    	                    "Not payed", JOptionPane.INFORMATION_MESSAGE);
    	    		return false;
    			}else{
    				return true;
    			}
    		} catch (HeadlessException | SQLException e1) {
    			JOptionPane.showMessageDialog(null, "Check out error", 
